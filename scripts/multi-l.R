...
if (!dir.exists("plots/grbf")) {
  dir.create("plots/grbf")
}
if (!dir.exists("plots/grbf/k=2")) {
  dir.create("plots/grbf/k=2")
}
...
for (i in seq_along(l.list)) {
  ...
  png(
    paste0("plots/grbf/k=2/", l.list[i], ".png"),
    width = 8,
    height = 7,
    units = "in",
    res = 300
  ...
  if (i == 1) {
    cairo_pdf(
      paste0("plots/grbf/k=2/", l.list[i], ".pdf"),
      width = 8,
      height = 7
    )
    spaghettiPlot(
...
if (!dir.exists("plots/grbf/k=3")) {
  dir.create("plots/grbf/k=3")
}
...
for (i in seq_along(l.list)) {
  ...
  png(
    paste0("plots/grbf/k=3/", l.list[i], ".png"),
    width = 8,
    height = 7,
    units = "in",
    res = 300
  ...
  if (i == 1) {
    cairo_pdf(
      paste0("plots/grbf/k=3/", l.list[i], ".pdf"),
      width = 8,
      height = 7
    )
    spaghettiPlot(
