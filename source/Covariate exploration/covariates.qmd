...
model.crp <- readRDS(paste0(prefix, "cache/crp-ma/crp-6.RDS"))
```
...
In all comparisons, six-cluster models will be considered due to a balance of 
providing multiple unique cluster profiles whilst remaining manageable when
visualising. 
