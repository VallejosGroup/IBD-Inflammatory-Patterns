...
cairo_pdf("paper/NCS-6-cluster-smoothed.pdf", width = 9, height = 9)
grid::grid.newpage()
...
png("paper/NCS-6-cluster-smoothed.png",
    width = 9,
    height = 9,
    units = "in",
    res = 300)
