...
tryCatch({
  Cairo::CairoPNG("paper/alluvial-FCAL-all.png", 
                  width = 12 * 300, 
                  height = 6.75 * 300, 
                  dpi = 300)
  print(p)
  dev.off()
  cat("FCAL alluvial PNG saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("FCAL alluvial PNG Cairo approach failed:", e$message, "\n")
})

# Use Cairo for safe PDF output
tryCatch({
  Cairo::CairoPDF("paper/alluvial-FCAL-all.pdf", 
                  width = 12, 
                  height = 6.75)
  print(p)
  dev.off()
  cat("FCAL alluvial PDF saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("FCAL alluvial PDF Cairo approach failed:", e$message, "\n")
})
```
...
# Use Cairo for safe PNG output
tryCatch({
  Cairo::CairoPNG("plots/pprob-distribution.png", 
                  width = 8.5 * 300, 
                  height = 7.5 * 300, 
                  dpi = 300)
  print(p)
  dev.off()
  cat("Posterior prob distribution PNG saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("Posterior prob PNG Cairo approach failed:", e$message, "\n")
})

# Use Cairo for safe PDF output
tryCatch({
  Cairo::CairoPDF("plots/pprob-distribution.pdf", 
                  width = 8.5, 
                  height = 7.5)
  print(p)
  dev.off()
  cat("Posterior prob distribution PDF saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("Posterior prob PDF Cairo approach failed:", e$message, "\n")
})
...
# Use Cairo for safe PDF output
tryCatch({
  Cairo::CairoPDF("paper/Residual-plot-fcal-ncs.pdf", 
                  width = 8, 
                  height = 8)
  print(p1 / p2)
  dev.off()
...
# Use Cairo for safe PNG output
tryCatch({
  Cairo::CairoPNG("paper/alluvial-FCAL-anchored.png", 
                  width = 12 * 300, 
                  height = 6.75 * 300, 
                  dpi = 300)
  print(p)
  dev.off()
  cat("FCAL anchored alluvial PNG saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("FCAL anchored PNG Cairo approach failed:", e$message, "\n")
})

# Use Cairo for safe PDF output
tryCatch({
  Cairo::CairoPDF("paper/alluvial-FCAL-anchored.pdf", 
                  width = 12, 
                  height = 6.75)
  print(p)
  dev.off()
  cat("FCAL anchored alluvial PDF saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("FCAL anchored PDF Cairo approach failed:", e$message, "\n")
})
...
# Use Cairo for safe PNG output
tryCatch({
  Cairo::CairoPNG("paper/alluvial-FCAL-grbf.png", 
                  width = 12 * 300, 
                  height = 6.75 * 300, 
                  dpi = 300)
  print(p)
  dev.off()
  cat("FCAL GRBF alluvial PNG saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("FCAL GRBF PNG Cairo approach failed:", e$message, "\n")
})

# Use Cairo for safe PDF output
tryCatch({
  Cairo::CairoPDF("paper/alluvial-FCAL-grbf.pdf", 
                  width = 12, 
                  height = 6.75)
  print(p)
  dev.off()
  cat("FCAL GRBF alluvial PDF saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("FCAL GRBF PDF Cairo approach failed:", e$message, "\n")
})
```
...
# Use Cairo for safe PNG output
tryCatch({
  Cairo::CairoPNG("plots/pprob-distribution-grbf.png", 
                  width = 8.5 * 300, 
                  height = 7.5 * 300, 
                  dpi = 300)
  print(p)
  dev.off()
  cat("GRBF posterior prob PNG saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("GRBF posterior prob PNG Cairo approach failed:", e$message, "\n")
})

# Use Cairo for safe PDF output
tryCatch({
  Cairo::CairoPDF("plots/pprob-distribution-grbf.pdf", 
                  width = 8.5, 
                  height = 7.5)
  print(p)
  dev.off()
  cat("GRBF posterior prob PDF saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("GRBF posterior prob PDF Cairo approach failed:", e$message, "\n")
})
...
# Use Cairo for safe PDF output
tryCatch({
  Cairo::CairoPDF("paper/Residual-plot-fcal-grbf.pdf", 
                  width = 8, 
                  height = 8)
  print(p1 / p2)
  dev.off()
  cat("GRBF residual plot PDF saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("GRBF residual plot PDF Cairo approach failed:", e$message, "\n")
})
...
# Use Cairo for safe PDF output
tryCatch({
  Cairo::CairoPDF("paper/cluster-resids-grbf.pdf", 
                  width = 8, 
                  height = 8)
  print(ArrangedPlot)
  dev.off()
  cat("GRBF cluster residuals PDF saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("GRBF cluster residuals PDF Cairo approach failed:", e$message, "\n")
})
...
# Use Cairo for safe PDF output
tryCatch({
  Cairo::CairoPDF("paper/comparison.pdf", 
                  width = 8.3, 
                  height = 11.7)
  print(final.plot)
  dev.off()
  cat("Comparison plot PDF saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("Comparison plot PDF Cairo approach failed:", e$message, "\n")
})

# Use Cairo for safe PNG output
tryCatch({
  Cairo::CairoPNG("paper/comparison.png", 
                  width = 8.3 * 300, 
                  height = 11.7 * 300, 
                  dpi = 300)
  print(final.plot)
  dev.off()
  cat("Comparison plot PNG saved successfully with Cairo\n")
}, error = function(e) {
  if (!is.null(dev.list())) dev.off()
  cat("Comparison plot PNG Cairo approach failed:", e$message, "\n")
})
