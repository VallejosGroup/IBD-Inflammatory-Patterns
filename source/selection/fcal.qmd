...
pprobs.10 <- c(); groups.10 <- models.fcal[[10]]
pprobs.11 <- c(); groups.11 <- models.fcal[[11]]
...
temp <- rank.full$Original[c(1, 5, 2, 6, 3, 7, 4, 8)]
...
##### Cumulative inflammation across first year


```{R}
rank.full <- rankCumulative(models.fcal[[8]], tmax = 1)
...
Having chosen the 10-cluster model to be the most appropriate, we have produced
