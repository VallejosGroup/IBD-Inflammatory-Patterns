...
tryCatch({
  Cairo::CairoPNG("plots/ma-nocor/alluvial.png", width = 12, height = 6.75, units = "in", res = 300)
  print(p)
  dev.off()
}, error = function(e) {
...
tryCatch({
  Cairo::CairoPDF("plots/ma-nocor/alluvial.pdf", width = 12, height = 6.75)
  print(p)
  dev.off()
}, error = function(e) {
...
# Save PNG with Cairo device
tryCatch({
  Cairo::CairoPNG("plots/pprob-distribution-crp-ma.png", width = 8.5, height = 8.5, units = "in", res = 300)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PNG:", e$message, "\n")
...
# Save PDF with Cairo device
tryCatch({
  Cairo::CairoPDF("plots/pprob-distribution-crp-ma.pdf", width = 8.5, height = 8.5)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
# Save PNG with Cairo device
tryCatch({
  Cairo::CairoPNG("plots/ma-nocor/anchored-alluvial.png", width = 12, height = 6.75, units = "in", res = 300)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PNG:", e$message, "\n")
...
# Save PDF with Cairo device
tryCatch({
  Cairo::CairoPDF("plots/ma-nocor/anchored-alluvial.pdf", width = 12, height = 6.75)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
