...
# Save PNG with Cairo device
tryCatch({
  Cairo::CairoPNG("plots/fc-prob-fup.png", width = 11, height = 8, units = "in", res = 300)
  print(fc_fup)
  dev.off()
}, error = function(e) {
...
# Save PDF with Cairo device
tryCatch({
  Cairo::CairoPDF("plots/fc-prob-fup.pdf", width = 11, height = 8)
  print(fc_fup)
  dev.off()
}, error = function(e) {
...
```{R}
x <- with(myDF.fc, table(as.factor(year(date.of.diag)), class_order_original))
x <- as.matrix(x)
i <- 0
while (any(x < 5)) {
  if (any(x[i, ] < 5)) {
...
To explore a potential relationship between cluster assignment and era effect,
we have investigated year of diagnosis and cluster assignment. However, as fewer than five subjects were diagnosed in some years for specific clusters, we have grouped years together.
...
#| results: "asis"
#| echo: false
htmltools::tags$ul(lapply(rownames(x), function(x) htmltools::tags$li(x)))
```


```{R}
#| label: fig-fc-year
#| fig-cap: "Proportion of subjects assigned to each FC cluster by year of diagnosis. Years with fewer than five subjects in a cluster are grouped together."
myDF.fc <- myDF.fc %>%
...
# Save PDF with Cairo device
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-diagyear.pdf", width = 8, height = 6)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
p_n.total_all <- myDF.fc %>%
  ggplot(aes(x = class_order, y = n.total)) +
  geom_violin(fill = "#5DB7DE", color = "#434371") +
  geom_boxplot(width = 0.1, color = "black", alpha = 0.2) +
  theme_minimal() +
  xlab("Cluster") +
...
p_mlr_all <- myDF.fc %>%
  ...
  mlrPlot(var = c("diagnosis", "age", "sex", "n.total"), class = "class_order")
...
`r perc.fc1`% of subjects in FC1 have Crohn's disease whilst `r perc.rest`% of
subjects in the other clusters have Crohn's disease.
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-diagnosis.pdf", width = 15, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
# Used to combine with the Lothian data
p <- dk %>%
  filter(Model %in% c("Multivariate", "Multivariate (prob >=0.5)")) %>%
  mutate(Model = factor(Model, levels = c("Multivariate (prob >=0.5)", "Multivariate"))) %>%
  libdr:::.plotCI("diagnosisUlcerative Colitis")

# Save PDF with Cairo device
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-diagnosis-dk-forest.pdf", width = 15, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
p_mlr_all <- myDF.fc %>%
  mutate(class_order = relevel(class_order, ref = "FC1")) %>%
  mlrPlot(
    var = c("diagnosis", "age", "sex", "n.total"),
    class = "class_order",
    extern = dk
  )
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-sex-age.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
```{R}
p <- ((wrap_elements(p_n.total_all) + p_mlr_all$plot_everything$n.total) + 
    plot_layout(guides = "collect")) &
    theme(legend.position = "bottom") &
    plot_annotation(tag_levels = "A")  &
    theme(plot.tag = element_text(face = "bold", size = 22))
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-n.total.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
As shown above,
`r sum(myDF.fc$missingN_cd[myDF.fc$diagnosis == "Crohn's Disease"] > 0)`
subjects will be excluded hereafter. 
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-cd-age.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-cd-sex.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-cd-smoking.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-location.pdf", width = 15, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-L4.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-behaviour.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-perianal.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-uc-age.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-uc-sex.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-uc-smoking.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/fc-extent.pdf", width = 15, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
# Save PDF with Cairo device
tryCatch({
  dir.create("paper", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("paper/Figure-3.pdf", width = 8 * 3 / 4, height = 12 * 3 / 4)
  print(p1)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("paper", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPNG("paper/Figure-3.png", width = 8 * 3 / 4, height = 12 * 3 / 4, units = "in", res = 300)
  print(p1)
  dev.off()
}, error = function(e) {
  cat("Error saving PNG:", e$message, "\n")
...
# Save CRP followup plots with Cairo device
tryCatch({
  Cairo::CairoPNG("plots/crp-prob-fup.png", width = 11, height = 8, units = "in", res = 300)
  print(crp_fup)
  dev.off()
}, error = function(e) {
  cat("Error saving PNG:", e$message, "\n")
...
tryCatch({
  Cairo::CairoPDF("plots/crp-prob-fup.pdf", width = 11, height = 8)
  print(crp_fup)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
# Save combined probability plots with Cairo device
tryCatch({
  Cairo::CairoPDF("plots/prob-fup.pdf", width = 11 * 3 / 4, height = 16 * 3 / 4)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  Cairo::CairoPNG("plots/prob-fup.png", width = 11 * 3 / 4, height = 16 * 3 / 4, units = "in", res = 300)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PNG:", e$message, "\n")
...
```{R}
x <- with(myDF.crp, table(as.factor(year(date.of.diag)), class_order))
x <- as.matrix(x)
i <- 0
while (any(x < 5)) {
...
To explore a potential relationship between cluster assignment and era effect,
we have investigated year of diagnosis and cluster assignment. However, as fewer
than five subjects were diagnosed in some years for specific clusters, we have
grouped years together.
...
```{R}
#| label: fig-crp-year
#| fig-cap: "Proportion of subjects assigned to each CRP cluster by year of diagnosis. Years with fewer than five subjects in a cluster are grouped together."
myDF.crp <- myDF.crp %>%
  mutate(year = plyr::mapvalues(year(date.of.diag),
    from = c(
      2008,
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-diagyear.pdf", width = 8, height = 6)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-diagnosis.pdf", width = 15, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-diagnosis-dk-forest.pdf", width = 15, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-sex-age.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-age.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-sex.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-cd-smoking.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-location.pdf", width = 15, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-L4.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-behaviour.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-extent.pdf", width = 15, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("plots/associations", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("plots/associations/crp-uc-smoking.pdf", width = 12, height = 12)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("paper", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("paper/CRP-AT.pdf", width = 8 * 3 / 4, height = 12 * 3 / 4)
  print(p1)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
...
tryCatch({
  dir.create("paper", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPNG("paper/CRP-AT.png", width = 8 * 3 / 4, height = 12 * 3 / 4, units = "in", res = 300)
  print(p1)
  dev.off()
}, error = function(e) {
  cat("Error saving PNG:", e$message, "\n")
