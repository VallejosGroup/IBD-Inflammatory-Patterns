...
for (g in 1:8) {
  ...
  km <- survfit(Surv(AT_line_1_cens, AT_7Y) ~ 1, data = temp.uc, stype = 2)
  km.df <- rbind(km.df,
                 data.frame(time = km$time,
                            cumhaz =  1 - km$surv,
                            class = paste0("FC", g),
...
ggsave("plots/crp-prob-fup.png", p2, width = 11, height = 8, units = "in")
ggsave("plots/crp-prob-fup.pdf", p2, width = 11, height = 8, units = "in")
```
