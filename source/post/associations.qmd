...
wrap_elements(p_smoke_uc) + p_mlr_uc$plot$SmokeYes + 
  plot_annotation(title = "Smoking (UC patients only)")
wrap_elements(p_extent_uc) + p_mlr_uc$plot$ExtentE2 + p_mlr_uc$plot$ExtentE3 + 
  plot_annotation(title = "Extent (UC patients only)")
```
