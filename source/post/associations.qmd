...
myDF.fc$class_combined <- factor(myDF.fc$class_combined,
                                 levels = c("FC1", "FC2-3-9", "FC4", "FC5", "FC6", "FC7", "FC8", "FC10"))
```
...
cd.dict.fc <- subset(myDF.fc, diagnosis == "Crohn's Disease")
...
p <- libdr::plotCat(myDF.fc, "diagnosis")
