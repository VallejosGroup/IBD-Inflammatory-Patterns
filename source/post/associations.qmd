...
for (g in 1:8) {
  ...
  km.df <- rbind(km.df,
                 data.frame(time = km$time,
                            cumhaz =  1 - km$surv,
                            class = paste0("FC", g, ", CD=", nrow(temp.cd), "; UC=", nrow(temp.uc)),
...
ggsave("paper/Figure-3.pdf", p1, width = 8 * 3/4, height = 12 * 3/4, units = "in")
ggsave("paper/Figure-3.png", p1, width = 8 * 3/4, height = 12 * 3/4, units = "in")
```
...
for (g in 1:8) {
  ...
  km.df <- rbind(km.df,
                 data.frame(time = km$time,
                            cumhaz =  1 - km$surv,
                            class = paste0("CRP", g, ", CD=", nrow(temp.cd), "; UC=", nrow(temp.uc)),
                            diag = "Crohn's disease"))
