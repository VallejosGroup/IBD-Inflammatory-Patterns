...
```{r}
myDF.fc <- myDF.fc %>%
  mutate(missingN = is.na(Smoke) + is.na(Location) + is.na(L4) + 
...
wrap_elements(p_smoke_cd) + p_mlr_cd$plot$SmokeYes + 
  plot_annotation(title = "Smoking (CD patients only)")
wrap_elements(p_location_cd) + p_mlr_cd$plot$LocationL2 + p_mlr$plot$LocationL3 + 
  plot_annotation(title = "Location (CD patients only)")
wrap_elements(p_L4_cd) + p_mlr_cd$plot$L4Yes +
  plot_annotation(title = "L4 (CD patients only)")
wrap_elements(p_behaviour_cd) + p_mlr_cd$plot$`Behaviour_mergedB2 or B3` +
  plot_annotation(title = "Behaviour (CD patients only)")
wrap_elements(p_perianal_cd) + p_mlr_cd$plot$PerianalYes + 
...
wrap_elements(p_smoke) + p_mlr$plot$SmokeYes + 
  plot_annotation(title = "Smoking (UC patients only)")
wrap_elements(p_location) + p_mlr$plot$LocationL2 + p_mlr$plot$LocationL3 + 
  plot_annotation(title = "Location (UC patients only)")
wrap_elements(p_L4) + p_mlr$plot$L4Yes +
  plot_annotation(title = "L4 (UC patients only)")
wrap_elements(p_behaviour) + p_mlr$plot$`Behaviour_mergedB2 or B3` +
  plot_annotation(title = "Behaviour (UC patients only)")
wrap_elements(p_perianal) + p_mlr$plot$PerianalYes + 
  plot_annotation(title = "Perianal (UC patients only)")
```
