...
tryCatch({
  Cairo::CairoPDF("plots/overlap.pdf", width = 14, height = 10)
  print(p)
  dev.off()
}, error = function(e) {
...
tryCatch({
  Cairo::CairoPNG("plots/overlap.png", width = 14, height = 10, units = "in", res = 300)
  print(p)
  dev.off()
}, error = function(e) {
...
tryCatch({
  ...
  Cairo::CairoPNG("paper/big-comp.png", width = 12, height = 11, units = "in", res = 300)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PNG:", e$message, "\n")
...
tryCatch({
  dir.create("paper", recursive = TRUE, showWarnings = FALSE)
  Cairo::CairoPDF("paper/big-comp.pdf", width = 12, height = 11)
  print(p)
  dev.off()
}, error = function(e) {
  cat("Error saving PDF:", e$message, "\n")
