...
Here, we also show the distribution of the diagnostic FCAL measurement with
...
And, finally, we retime measurements/diagnosis time as described above.
...
<!--- CAV: edit the plot below such that it doesn't show individual dots, you
could e.g. use geom_hex ---> 
